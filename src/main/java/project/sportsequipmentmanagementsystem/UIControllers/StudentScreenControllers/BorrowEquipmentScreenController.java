...
public class BorrowEquipmentScreenController {
    ...
    public DatePicker dateOfBorrowRequestTextField= new DatePicker();
    public TextField timeOfBorrowRequestTextField = new TextField();
    ...
    public void borrowEquipment() {
        new EducationalInstitute().processBorrowRequest(equipmentIDTextField.getText(),studentIDTextField.getText(),new Date(dateOfBorrowRequestTextField.getValue().toString()+" "+timeOfBorrowRequestTextField.getText()));
    }
}
